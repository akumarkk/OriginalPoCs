...
public class AircraftInfoApiHealthCheckService : IHealthCheck
{
    private readonly IHttpClientFactory _httpClientFactory;

    public AircraftInfoApiHealthCheckService(IHttpClientFactory httpClientFactory)
    {
    ...
    var dataunh = new Dictionary<string, object>
        ...
        try
        {
            ...
            var response = await client.GetAsync("https://api.github.com/google", cancellationToken);
